...
- **What 8.1 deliberately does not do** (all 8.2, `docs/PHASE8_PLAN_8.2.md`): no error visibility, no uptime ping, no ingest-failure mail — an ingest that dies is found by the item count not moving. And no one but Ben and the twenty personas is invited until 8.2 T6.
