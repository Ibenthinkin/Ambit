...
- **One rendition since 8.3** (`docs/DESIGN_landing-redo.md` D3): `?w=960` serves a ≤960 px WebP at
  ...
  size. Only the landing reel uses it today. `bun run img:warm --rendition 960 --landing` pre-derives
