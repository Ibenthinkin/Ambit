...
export function ProfileScreen() {
  ...
  return (
    <main className="bg-bg text-ink min-h-dvh">
      {/* The desktop cap (docs/DESIGN_desktop-polish.md §1). It opens above the settings button so
          the gear lands on the column's right edge rather than the viewport's, which is where the
          eye looks for it once the content below has stopped stretching. The pill and the sheets
          below are fixed chrome and stay outside. */}
      <Column width="narrow">
